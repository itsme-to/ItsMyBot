import { Condition, ConditionArgumentValidator, ConditionData, Context, IsNumberMeta, IsValidMetaKey, Variable, Utils, IsNumberOrString } from '@itsmybot';
...
export default class MetaBelowCondition extends Condition {
  id = "metaBelow";
